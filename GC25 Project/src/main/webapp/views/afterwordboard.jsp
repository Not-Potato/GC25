					...
					<div class="d-flex justify-content-between">
						...
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
								<li><a class="dropdown-item" href="${contextPath}/afterwordboard/afterwordboard.do?searchType=최신순">최신순</a></li>
								<li><hr class="dropdown-divider"></li>
								<li><a class="dropdown-item" href="${contextPath}/afterwordboard/afterwordboard.do?searchType=추천순">추천순</a></li>
								<li><hr class="dropdown-divider"></li>
								<li><a class="dropdown-item" href="${contextPath}/afterwordboard/afterwordboard.do?searchType=댓글순">댓글순</a></li>
								<li><hr class="dropdown-divider"></li>
								<li><a class="dropdown-item" href="${contextPath}/afterwordboard/afterwordboard.do?searchType=조회순">조회순</a></li>
							</ul>
						</div>
					</div>
					...
					<div class="w-800">
						...
						<c:otherwise>
							<c:forEach  var="after" items="${ list }" varStatus="afterNum" >
								<div class="card my-3" onclick="location.href='${contextPath}/afterwordboard/afterwordviewer.do?boardNum=${ list[afterNum.index].boardNumber }'">
