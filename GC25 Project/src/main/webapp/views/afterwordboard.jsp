					...
					<div class="d-flex justify-content-between">
						...
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
								<li><a class="dropdown-item" href="${contextPath}/afterword/board?searchType=최신순">최신순</a></li>
								<li><hr class="dropdown-divider"></li>
								<li><a class="dropdown-item" href="${contextPath}/afterword/board?searchType=추천순">추천순</a></li>
								<li><hr class="dropdown-divider"></li>
								<li><a class="dropdown-item" href="${contextPath}/afterword/board?searchType=댓글순">댓글순</a></li>
								<li><hr class="dropdown-divider"></li>
								<li><a class="dropdown-item" href="${contextPath}/afterword/board?searchType=조회순">조회순</a></li>
							</ul>
						</div>
					</div>
					...
					<nav>
						<ul class="pagination justify-content-center mt-5">
							...
							<c:choose>
								...
								<c:otherwise>
									<li class="page-item"><a class="page-link" href="${contextPath}/afterword/board.do?pageNum=${ startPage - 1 }&searchType=${ searchType }">◀</a></li>
								</c:otherwise>
							</c:choose>
							...
							<c:choose>
								<c:when test="${ endPage != totalPage }">
									<li class="page-item disabled"><a class="page-link" href="${contextPath}/afterword/board.do?pageNum=${ endPage + 1 }&searchType=${ searchType }">▶</a></li>
								</c:when>
								<c:otherwise>
									<li class="page-item disabled"><a class="page-link" href="#">▶</a></li>
								</c:otherwise>
